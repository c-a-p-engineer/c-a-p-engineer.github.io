...
![メニューバー表示](/images/blog/2021-05-08-electron-nomenu/electron-menu.png "メニューバー表示") 

## メニューバー非表示
ソースは `Electron` の<a href="https://www.electronjs.org/docs/tutorial/quick-start#quick-start-guide" target="_blank" rel="noopener">Quick Start Guide | Electron</a>のものを使っています。
...
![メニューバー非表示](/images/blog/2021-05-08-electron-nomenu/electron-nomenu.png "メニューバー非表示") 