...
categories: []
draft: false
legacySlug: colab-opencv-face-rectangle-drawing
...
![before](/legacy-assets/colab-opencv-face-rectangle-drawing/before.png "before")

実行すると以下のように顔の判定をして四角で囲まれます。

![after](/legacy-assets/colab-opencv-face-rectangle-drawing/after.png "after")
