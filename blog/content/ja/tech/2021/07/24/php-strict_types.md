...
* PHP 7.0.0以上
PHP7の時に実装された機能になります。
* <a href="https://www.php.net/manual/ja/migration70.new-features.php" target="_blank" rel="noopener">PHP 5.6.x から PHP 7.0.x への移行 (新機能)</a>
...
## 参考
* <a href="https://www.php.net/manual/ja/language.types.declarations.php#language.types.declarations.strict" target="_blank" rel="noopener">厳密な型付け</a>
