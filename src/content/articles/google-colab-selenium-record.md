...
categories: []
draft: false
legacySlug: google-colab-selenium-record
...
![screenshot](/legacy-assets/google-colab-selenium-record/1.png "screenshot")
![screenshot](/legacy-assets/google-colab-selenium-record/2.png "screenshot")
![screenshot](/legacy-assets/google-colab-selenium-record/3.png "screenshot")

撮影した動画（出力ファイルはmkvですがmp4に変換したものを載せています。

<video style="width:300px;" autoplay loop>
    <source src="./ouxkt.mp4" type="video/mp4">
</video>
