...
categories: []
draft: false
legacySlug: git-log-pretty-format
...
![git-log](/legacy-assets/git-log-pretty-format/git-log.png "git-log")
...
![git-log-pretty-format](/legacy-assets/git-log-pretty-format/git-log-pretty-format.png "git-log-pretty-format")
